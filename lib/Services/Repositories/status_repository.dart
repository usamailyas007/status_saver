...
class StatusRepository {
  ...
  Future<List<FileSystemEntity>> fetchStatus({required String ext, required String path}) async {
    try {
      var statuses = <FileSystemEntity>[];
      final Directory videoDir = Directory(path);
      ...
      debugPrint(statuses.length.toString());
      return statuses;
    } catch (e) {
